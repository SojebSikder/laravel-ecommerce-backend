                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="float-start">Edit tag</h5>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="form-check form-switch mb-3 mt-5">
                                                    ...
                                                    @if ($tag->status == 1) checked @endif value="1" name="status"
...
@section('script')
    ...
    <script>
        ...
        label.addEventListener("keyup", function(e) {
            name.value = replace(e.target.value.toLowerCase(), " ", "-")
        });
    </script>
@endsection
