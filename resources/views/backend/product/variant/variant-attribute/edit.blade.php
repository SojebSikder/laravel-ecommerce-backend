                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="float-start">Edit variant attribute</h5>
                                <a href="{{ route('variant.edit', $variant_attribute->variant_id) }}"
                            ...
                            <div class="card-body">
                                <form action="{{ route('variant_attribute.update', $variant_attribute->id) }}"
                                                        ...
                                                        @if (count($attributes) > 0)
                                                            @foreach ($attributes as $attribute)
                                                                <option value={{ $attribute->id }}
                                                                    @if ($variant_attribute->attribute_id == $attribute->id) selected @endif>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const attribute_value_id = <?php echo json_encode($variant_attribute->attribute_value_id); ?>;
            attributeValueSelect.val(attribute_value_id).trigger('change');
