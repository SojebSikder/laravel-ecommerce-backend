                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="float-start">Create coupon</h5>
                                        ...
                                        <div id="minGroup" class="row">
                                            ...
                                            <div id="minQuantityGroup" class="col-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        value="{{ old('min_qnty') }}" name="min_qnty">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="maximumUsesGroup" class="row">
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" value="{{ old('max_uses') }}"
                                                    name="max_uses">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control"
                                                    value="{{ old('max_uses_user') }}" name="max_uses_user">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    {{-- <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" class="form-control" value="{{ old('starts_at') }}"
                                                    name="starts_at">
                                            </div>
                                        </div>
                                    </div> --}}
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" class="form-control"
                                                    value="{{ old('expires_at') }}" name="expires_at">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/ end date -->
