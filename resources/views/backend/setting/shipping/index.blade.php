                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('shipping.create') }}" class="btn btn-sm btn-primary float-end mt-3 mr-4">
                                                ...
                                                <tr>
                                                    ...
                                                    @if ($shipping->status == 1)
                                                        <td class="text-center">
                                                            <a href="{{ route('shipping.status', $shipping->id) }}"
                                                        ...
                                                        <ul class="table-controls">
                                                            <li>
                                                                <a class="btn btn-sm btn-primary"
                                                                    href="{{ route('shipping.edit', $shipping->id) }}"
                                                            ...
                                                            <li>
                                                                <a class="btn btn-sm btn-danger" href="javascript:void(0);"
                                                                    ...
                                                                    document.getElementById('shipping-delete-{{ $shipping->id }}').submit()
                                                                    }"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                ...
                                                                <form method="post"
                                                                    ...
                                                                    id="{{ 'shipping-delete-' . $shipping->id }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                            </li>
