                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="float-start">Edit status</h5>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="name"
                                                        ...
                                                        placeholder="e.g. order_processing" value="{{ $status->name }}"
                                                        name="name">
                                                </div>
                                                @error('name')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description">{{ $status->description }}</textarea>
                                                </div>
                                                @error('description')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" id="sort_order"
                                                        ...
                                                        value="{{ $status->sort_order }}" name="sort_order">
                                                </div>
                                                @error('sort_order')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col">
                                                <div class="form-check form-switch mb-3 mt-5">
                                                    <input class="form-check-input" value="1"
                                                        name="on_shipping_status" type="checkbox" role="switch"
                                                        id="on_shipping_status">
                                                    <label class="form-check-label" for="on_shipping_status">Show on
