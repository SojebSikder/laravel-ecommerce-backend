                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="float-start">Edit currency</h5>
                                            ...
                                            <div class="col">
                                                <div class="form-check form-switch mb-3 mt-5">
                                                    <input class="form-check-input"
                                                        @if ($currency->status == 1) checked @endif value="1"
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="currency_code"
                                                        ...
                                                        value="{{ $currency->currency_code }}" name="currency_code"
                                                        placeholder="e.g. USD">
                                                </div>
                                                @error('currency_code')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="currency_sign"
                                                        ...
                                                        value="{{ $currency->currency_sign }}" name="currency_sign"
                                                        placeholder="e.g. $">
                                                </div>
                                                @error('currency_sign')
                                                    <div class="alert alert-danger">{{ $message }}</div>
